...
function addField(sectionType, appSchema, field, targetID, key, section, version, withActions = true, containersSchema = {}) {
    ...
    if (!field || !field.$Type) {
        ...
        if (withActions && sectionType === ux_specification_types_2.SectionType.Section) {
            const actionsProperties = getFieldsSchemaContainer(appSchema, `${sectionType}${ux_specification_types_2.DefinitionName.Actions}<${targetID}>`, containersSchema.actions);
        ...
        const fieldsProperties = getFieldsSchemaContainer(appSchema, `${sectionType}${ux_specification_types_2.DefinitionName.Fields}<${targetID}>`, containersSchema.fields);
...
function addTagsToFormDefinition(section, appSchema, formDefinitionKey) {
    ...
    if (section.entityType?.name) {
        appSchema.definitions[formDefinitionKey][ux_specification_types_2.SchemaTag.annotationPath] = (0, __1.createAnnotationPath)(section.entityType.fullyQualifiedName, section.target['term'], section.target['qualifier']);
    }
}
/**
...
function handleForm(sectionType, section, appSchemaSection, appSchema, version, facetKey) {
    ...
    const formDefinitionKey = (0, __1.prepareRef)(`${sectionType}${ux_specification_types_2.DefinitionName.Form}<${targetID}>`);
    const fieldsDefinitionKey = (0, __1.prepareRef)(`${sectionType}${ux_specification_types_2.DefinitionName.Fields}<${targetID}>`);
    const actionsDefinitionKey = (0, __1.prepareRef)(`${sectionType}${ux_specification_types_2.DefinitionName.Actions}<${targetID}>`);
...
function addFooterActions(appSchema, generateParameters, version, addFooterActionCallBack) {
    ...
    const alias = (0, __1.findAlias)(ux_specification_types_2.UIVOCABULARY, generateParameters.serviceAVT);
    ...
    if (actionAnnotation) {
        ...
        footerActions[ux_specification_types_2.SchemaTag.annotationPath] = `/${entityType.fullyQualifiedName}/@${"com.sap.vocabularies.UI.v1.Identification" /* UIAnnotationTerms.Identification */}`;
    }
...
function addHeaderActions(appSchema, entityType, oDataServiceAVT, addHeaderActionCallBack) {
    ...
    const alias = (0, __1.findAlias)(ux_specification_types_2.UIVOCABULARY, oDataServiceAVT);
    ...
    if (identification) {
        ...
        headerActions[ux_specification_types_2.SchemaTag.annotationPath] = `/${entityType.fullyQualifiedName}/@${"com.sap.vocabularies.UI.v1.Identification" /* UIAnnotationTerms.Identification */}`;
    }
}
...
function addCommonHeaderSchema(appSchema, entityType) {
    ...
    appSchema.definitions[ux_specification_types_2.DefinitionName.ObjectPageHeader][ux_specification_types_2.SchemaTag.annotationPath] = `/${entityType.fullyQualifiedName}/@${"com.sap.vocabularies.UI.v1.HeaderInfo" /* UIAnnotationTerms.HeaderInfo */}`;
}
